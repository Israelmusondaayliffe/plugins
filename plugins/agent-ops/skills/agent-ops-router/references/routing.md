...
astra-advisor-explicit: route only a genuine current request for Astra Advisor to astra-advisor on Codex.
fable-advisor-explicit: route only a genuine current request for Fable Advisor to fable-advisor on Claude Code. Preserve peer-workflow exclusion and optional Codex authorization.
