...
ProofLoop provides bounded task execution, explicit verification, quarantined
learning records, governed memory review, and read-only audits.

## Install

On Codex:

    codex plugin add proofloop@community-agent-plugins
