...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="925" y="236" fill="#292729" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="52">28</text>
  <text x="925" y="268" fill="#6B6864" font-family="Avenir Next, Helvetica Neue, Arial, sans-serif" font-size="15">PUBLIC PLUGINS</text>
  <text x="925" y="354" fill="#292729" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-size="52">204</text>
